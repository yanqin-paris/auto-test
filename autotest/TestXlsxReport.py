...
workbook = xlsxwriter.Workbook(GetTestReportPath()+now+'report.xlsx')#生成的报告的路径
...
def init(worksheet):
    ...
    data = {"test_name": "女神派接口", "test_version": "v1.0.0", "test_pl": "Python3", "test_net": "http://api0.test.msparis.com/"}
    ...
    worksheet.merge_range('F4:F6', str((round(hpassnum/len(TestReport),2))*100)+'%', get_format_center(workbook))
